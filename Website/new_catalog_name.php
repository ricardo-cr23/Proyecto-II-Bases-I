			...
			$CategorySelected = $_GET['selectedOption'];  
		        ...
		        if ($CategorySelected == "Order"){  
					...
					if ($result->num_rows > 0) {
						 echo '<select name="Class" id = "Other">';
					...
					if ($result->num_rows > 0) {
						 echo '<select name="Order" id = "Other">';
					...
					if ($result->num_rows > 0) {
						 echo '<select name="Sub_Order" id = "Other">';
					...
					if ($result->num_rows > 0) {
						 echo '<select name="Family" id = "Other">';
					...
					if ($result->num_rows > 0) {
						 echo '<select name="Gender" id = "Other">';
						 echo '<option value = "-1">Select Family:</option>';
